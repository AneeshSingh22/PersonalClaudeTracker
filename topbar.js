...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = (window.DASH_SUPABASE_URL) || 'https://yokjivukmvojmgibsdne.supabase.co';
  const TOPBAR_SUPABASE_KEY = (window.DASH_SUPABASE_KEY) || 'sb_publishable_jDV1OzFSz2K2GaWTkYvEaw_F-62lAnW';
...
<nav class="bottombar" id="bottombar" role="navigation" aria-label="Main tabs">
  ...
  <a href="checklist.html" class="bottombar-tab" data-page="checklist">
    <span class="bottombar-tab-icon">✅</span>
    <span>Checklist</span>
  </a>
</nav>
`;
  ...
  function currentPageKey() {
    ...
    if (p.endsWith('checklist.html')) return 'checklist';
